...
gotoxy(23,7);           printf("ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»");
gotoxy(23,8);	        printf("º                                     º");
gotoxy(23,9);	        printf("ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹");
gotoxy(23,10);         	printf("º                                     º");
gotoxy(23,11);		printf("º                                     º");
gotoxy(23,12);		printf("º                                     º");
gotoxy(23,13);		printf("º                                     º");
gotoxy(23,14);		printf("º                                     º");
gotoxy(23,15);		printf("º                                     º");
gotoxy(23,16);		printf("º                                     º");
gotoxy(23,17);		printf("º                                     º");
gotoxy(23,18);		printf("º                                     º");
gotoxy(23,19);		printf("º                                     º");
gotoxy(23,20);		printf("º                                     º");
gotoxy(23,21);		printf("º                                     º");
gotoxy(23,22);		printf("ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼");
...
gotoxy(16,5);	printf("ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿");
gotoxy(16,6);	printf("³                                                       ³");
gotoxy(16,7);	printf("³                                                       ³");
gotoxy(16,8);	printf("³                                                       ³");
gotoxy(16,9);	printf("³                                                       ³");
...
gotoxy(16,18);  printf("³                                                       ³");
gotoxy(16,19);	printf("³                                                       ³");
gotoxy(16,20);	printf("ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ");
